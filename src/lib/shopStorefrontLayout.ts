...
export const defaultStorefrontLayout: StorefrontLayout = {
  ...
  pages: {
    top: {
      ...
      sections: {
        recommendedProducts: { enabled: true, title: "おすすめ商品", limit: 10 },
        ranking: { enabled: true, title: "売れ筋ランキング", limit: 5 },
        timeSale: { enabled: true, title: "タイムセール", limit: 5 },
        categories: { enabled: true, title: "カテゴリー一覧", limit: 8 },
