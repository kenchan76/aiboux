...
export const inputGroup = tv({
  base: [
    "border-input group/input-group relative flex h-11 w-full min-w-0 items-center rounded-lg border transition-colors outline-none",
...
export const inputGroupInput = tv({
  base: "h-full flex-1 rounded-none border-0 shadow-none ring-0 outline-none focus-visible:ring-0 disabled:bg-transparent aria-invalid:ring-0",
});
...
export const inputGroupTextarea = tv({
  base: "h-full flex-1 resize-none rounded-none border-0 shadow-none ring-0 outline-none focus-visible:ring-0 disabled:bg-transparent aria-invalid:ring-0",
});
