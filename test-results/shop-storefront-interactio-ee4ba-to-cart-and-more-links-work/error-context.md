...
- Name: shop-storefront-interaction-public.spec.ts >> AIBOUX Shop public storefront interactions >> public product card, add-to-cart, and more links work
- Location: tests/shop-storefront-interaction-public.spec.ts:71:3
...
Locator:  getByTestId('bestseller-ranking').getByRole('link', { name: 'もっと見る' })
Expected: "/s/aiboux/products?category=ranking"
Received: "/s/aiboux/products"
Timeout:  10000ms

Call log:
  - Expect "toHaveAttribute" with timeout 10000ms
  - waiting for getByTestId('bestseller-ranking').getByRole('link', { name: 'もっと見る' })
    24 × locator resolved to <a href="/s/aiboux/products" class="text-xs font-semibold text-blue-700 hover:text-blue-900 hover:underline">もっと見る</a>
       - unexpected value "/s/aiboux/products"
